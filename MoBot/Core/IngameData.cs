...
namespace MoBot.Core
{
    public class IngameData
    {
        ...
        public IList<Entity> LivingEntities { get; } = new List<Entity>();
        ...
        {
            if (entities.TryRemove(entityId, out var entity)) return entity;
            Console.WriteLine($"Cannot remove Entity {entityId} to collection!");
            return null;
        }
